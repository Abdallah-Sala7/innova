import { Circle, DotIcon, Square, Star } from "lucide-react";

const AnimatedBg = () => {
  return (
    <>
      <Star className="absolute -z-10 start-1/4 text-clr2 animate-spin-slow top-10" />
      <Square className="absolute -z-10 start-5 text-purple-700 animate-spin-slow top-1/3" />
      ...
      <DotIcon
        size={80}
        className="absolute -z-10 start-1/2 text-primary animate-pulse top-1/4"
      />
      <Star className="absolute -z-10 end-5 text-purple-700 animate-spin-slow top-10" />
      <Square className="absolute -z-10 end-10 text-green-500 animate-spin-slow top-1/2 " />
      ...
      <DotIcon
        size={80}
        className="absolute -z-10 end-1/2 text-primary animate-pulse bottom-0"
      />
    </>
  );
};
